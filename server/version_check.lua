...
Citizen.CreateThread( function()
    updatePath = "/LetsTiger/tg_3dtext"
    resourceName = "3D-Text Script ("..GetCurrentResourceName()..")"
...
function Resourcestart()
    ...
    if rio then
        print("^4|▶ ^0[^1ERROR^0] ^1"..resourceName.." ist veraltet! Bitte updaten: https://github.com/LetsTiger/tg_3dtext/        ^4|")
