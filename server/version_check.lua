...
Citizen.CreateThread(function()
    ...
    local resourceName = "3D Text Script (" .. GetCurrentResourceName() .. ")"
    local scriptName = "tg_3dtext"
    ...
    function printVersionInfo(status, curVersion, newVersion)
        print('^4.-------------------------------------------------------------------------------------------------------------------.')
        print('^4|^0                                             TG 3D Text Script                                                     ^4|')
        print('^4|^0                                    <Made by Tiger (Discord: lets_tiger)>                                          ^4|')
        print('^4|-------------------------------------------------------------------------------------------------------------------|')

        if status == "veraltet" then
            print("^4|▶ ^0[^1ERROR^0] ^1" .. resourceName .. " ist veraltet! Bitte updaten: https://github.com/TGScripts/tg_3dtext           ^4|")
